...
/** @var gl $gl */
$gl = $modx->getService('modvkmarket', 'modVkMarket', $modx->getOption('modvkmarket_core_path', null, $modx->getOption('core_path') . 'components/modvkmarket/') . 'model/modvkmarket/');
$modx->lexicon->load('modvkmarket:default');
// handle request
$corePath = $modx->getOption('modvkmarket_core_path', null, $modx->getOption('core_path') . 'components/modvkmarket/');
